$(document).ready(function() {
    ...
    // Listen for the custom event and update the value of the updatedUsername variable
    $(document).on('usernameUpdated', function(event, updatedUsername) {
      // Update the value of the updatedUsername variable in user.php
      var updatedUsername = updatedUsername;
      // Now you can use the updatedUsername variable in user.php as needed.
            ...
            if (data.status === 'success') {
              const updatedUsername = data.updatedUsername;
                ...
                Swal.fire({
                    ...
                    $('#displayUsername').text(updatedUsername); // Update the displayed username
